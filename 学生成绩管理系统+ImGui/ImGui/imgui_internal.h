...
//#endif
    ...
    IMGUI_API bool          MaximizeButton(ImGuiID id, const ImVec2& pos); //cty_flag_MaximizeButton
    IMGUI_API bool          MinimizeButton(ImGuiID id, const ImVec2& pos); //cty_flag_MinimizeButton
